...
{
    type:Shader3D,
    name:builtin-camera-texture_opaque,
    ...
    shaderPass:[
        {
            pipeline:Forward,
            VS:builtinCameraTextureOpaqueVS,
            FS:builtinCameraTextureOpaquePS
        }
    ]
}
Shader3D End
...
GLSL Start
#defineGLSL builtinCameraTextureOpaqueVS
    #define SHADER_NAME builtin-camera-texture_opaque
...
#defineGLSL builtinCameraTextureOpaquePS
    #define SHADER_NAME builtin-camera-texture_opaque
