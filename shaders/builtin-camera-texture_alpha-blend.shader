...
{
    type:Shader3D,
    name:builtin-camera-texture_alpha-blend,
    ...
    shaderPass:[
        {
            pipeline:Forward,
            VS:builtinCameraTextureAlphaBlendVS,
            FS:builtinCameraTextureAlphaBlendPS,
            blendState:{
                blend:true,
                blendSrc:BlendFactor.SourceAlpha,
                blendDst:BlendFactor.OneMinusSourceAlpha
            }
        }
    ]
}
...
GLSL Start
#defineGLSL builtinCameraTextureAlphaBlendVS
    #define SHADER_NAME builtin-camera-texture_alpha-blend
...
#defineGLSL builtinCameraTextureAlphaBlendPS
    #define SHADER_NAME builtin-camera-texture_alpha-blend
